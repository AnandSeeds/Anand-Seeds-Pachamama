...
void loop() {
    ...
    GetUV();
    mostrarFecha();    
    mostrarRegistrosLCD();//Humedad y Temperatura, Aire y Suelo
    mostrarRegistrosLCD2();//Nivel UV e Intensidad UV
    mostrarRegistrosLCD3();//Latitud y Longitud
    enviarDatosSIM();
